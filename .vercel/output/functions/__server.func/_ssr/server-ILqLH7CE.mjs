...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-BoNurZx4.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DH-qyOud.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-D3-Xi4xp.mjs"),
		import("./start-zOBUXYXO.mjs"),
