 ...
 * Transport is pluggable; the default renders and records the intent so
...
<table style="width:100%;border-collapse:collapse;margin:16px 0;font-size:14px;line-height:1.6">
  ...
  <tr><td style="color:${BRAND.muted}">Timestamp:</td><td>${data["timestamp"] ?? new Date().toISOString()}</td></tr>
</table>`;
      break;
